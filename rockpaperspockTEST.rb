...
#outer loop
while human_score || computer_score >= 0 #tässä oli aiemmin < 3 #does not exit loop at >3 OISKO joku keep_playing = true ja break human || comp == 3
#break if human_score || computer_score == 3  
  loop do
  ...
  if choice == computer_choice
    ...
    computer_score = computer_score + 1 #OISKO TÄÄ JOKU SCOPING ISSUE?
  end 
